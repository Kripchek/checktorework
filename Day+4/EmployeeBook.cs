...
namespace Day_4
{
    public class EmployeeBook
    {
        ...
        public static void SalaryLessThanNumber()
        {
        ...
        public static void SalaryMoreThanNumber()
        {
            Console.WriteLine("Введите число: ");
            int chislo = Convert.ToInt32(Console.ReadLine());
        ...
        public static void List_of_employees()
        {
        ...
        public static void Fio_employees()
        {
